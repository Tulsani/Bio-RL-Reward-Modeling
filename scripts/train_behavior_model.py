"""Fit and diagnose the training-only logged behavior-policy model."""
...
from behavior_model import BehaviorPolicyModel, cross_validate_behavior_model

PROJECT_ROOT = Path(__file__).resolve().parents[1]


def main() -> None:
    config_path = PROJECT_ROOT / "config" / "behavior_model_config.json"
